...
pc = 0 #need pseudocount when working with frequencies
...
'''
nminseq = 1 # Num min seqs before removing allele
nminseqMS = 10 # Num min seqs before switching to all MS 
nminseqAL = 10 # Num min seqs before switching to all techs
NSmin = 10
'''
...
nc = len(list_hla_l)
if sum(range_len) == 19:
    out_par = 'YesReal_' + str(yesreal) + '_hu_' + str(hu) + '_l12' + str(l12) + '_AL' + str(np.mean(range_len)) +'_' +str(sum(range_len)) +'_SA' + str(SA) + '_RW' + strw + '_TR' + str(deg) + '_' + str(nminseqMS)
else:
    out_par = 'YesReal_' + str(yesreal) + '_hu_' + str(hu) + '_l12' + str(l12) + '_AL' + str(np.mean(range_len)) + '_SA' + str(SA) + '_RW' + strw + '_TR' + str(deg) + '_' + str(nminseqMS) + '_MS'
...
for runs in range(Nrun):
    ...
    if makereweighting:
       ...
       # ww=[]
       # for g in range(nc):
       #     ww.append(list(np.repeat(3000/len(iedb_data[g]), len(iedb_data[g]))))
       # all_weights = np.array(flatten_list(ww))
